...
public class BST {
    public static void main(String[] args) {
        ...
        System.out.println(isBST(head1, Integer.MAX_VALUE, Integer.MIN_VALUE)); //should return false
        System.out.println(isBST(head2, Integer.MAX_VALUE, Integer.MIN_VALUE));// should return false
    ...
    public static boolean isBST(TreeNode node, Integer max, Integer min) {
    		if (node == null) return true;
    		if (node.left != null && node.left.value >= max) return false;
    		if (node.right != null && node.right.value <= min) return false;
